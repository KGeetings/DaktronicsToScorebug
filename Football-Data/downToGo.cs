...
namespace UserScript
{
	...
	public class RunScript
	{
		...
		public string Eval()
		{
			...
			string filePath = "C:/Users/PCTech/Documents/Graphics Outfitters/Football-Data/downToGo.txt";

			if (File.ReadAllText("C:/Users/PCTech/Documents/Graphics Outfitters/Football-Data/down.txt") == "1st & " && (val % 5 != 0 || val == 0))
			{
