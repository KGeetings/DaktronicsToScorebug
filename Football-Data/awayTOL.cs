...
namespace UserScript
{
	...
	public class RunScript
	{
		...
		public string Eval()
		{
			...
			if(File.ReadAllText("C:/Users/PCTech/Documents/Graphics Outfitters/Football-Data/awayTOL.txt") == val.ToString())
			{
				return Output;
			}
			...
			string destinationFile = "C:/Users/PCTech/Documents/Graphics Outfitters/Football-Data/awayTOL.png";
			...
			File.WriteAllText("C:/Users/PCTech/Documents/Graphics Outfitters/Football-Data/awayTOL.txt", val.ToString());
